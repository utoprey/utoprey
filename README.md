...
Deep learning where neuroscience is — making brain signals tractable for machines.

- self-supervised & discrete representations, cross-modal alignment
- interpretability & shortcut-learning audits of neural foundation models
- **now** — a montage-agnostic EEG tokenizer
